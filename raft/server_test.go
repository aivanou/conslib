...
// 	err := s.OnAppendEntriesReceived(&protocol.AppendArgs{
// 		Term:         0,
// 		LeaderId:     "id2",
// 		PrevLogIndex: 1,
// 		PrevLogTerm:  1,
// 		LeaderCommit: 1,
// 		Entries:      make([]logstore.LogItem, 10)}, res)
// 	assert.Nil(t, err)
...
// 		PrevLogTerm:  1,
// 		LeaderCommit: 1,
// 		Entries:      make([]logstore.LogItem, 0, 10)}, res)
// 	assert.Nil(t, err)
...
// 	items := GenRandomLogItems(logSize, 1, 1)
// 	res := new(protocol.AppendResult)
// 	s.OnAppendEntriesReceived(&protocol.AppendArgs{
// 		Term:         2,
// 		LeaderId:     "id2",
// 		PrevLogIndex: 1,
// 		PrevLogTerm:  1,
